...
Для реализации моего проекта я выбрал мультиплатформенную разработку, так как хорошо знаком с веб разработкой и с фронтенд библиотеками React и Redux. Исходя из этого я выбрал React Native в качестве набора инструментов, так как он потребует от меня намного меньше времени для изучения чем остальные наборы инструментов.

Для себя я выявил следующие
